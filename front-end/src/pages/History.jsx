...
function History() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/users/${cookies.user_id}`)
      .then(res => {
        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="mx-4 mt-4">
                {isLoading ? (
                    ...
                    data.map((item) => (
                        <div key={item.order_id} className="max-w-xl mx-auto mb-4 bg-white rounded-md overflow-hidden shadow-md">
                            <div className="p-4">
                                <h5 className="text-xl font-semibold mb-2">Order ID: {item.order_id}</h5>
